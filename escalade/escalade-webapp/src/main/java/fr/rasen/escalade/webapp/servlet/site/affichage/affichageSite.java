package fr.rasen.escalade.webapp.servlet.site.affichage;
...
@WebServlet("/AffichageSite")
public class affichageSite extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        this.getServletContext().getRequestDispatcher("/WEB-INF/jsp/Site/affichage/affichageSite.jsp").forward(request, response);
    }
